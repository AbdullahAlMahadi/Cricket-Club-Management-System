...
public class PlayerHome extends JFrame implements ActionListener ,MouseListener
{
	...
	public PlayerHome(User user)
	{
		...
		coachBtn = new JButton("View Coach");
	...
	public void mouseEntered(MouseEvent me)
	{
		...
		{
			managerBtn.setBackground(color = new Color(154,205,50));
			managerBtn.setForeground(Color.BLACK);
		}
		else if(me.getSource()== playerBtn)
		{
			playerBtn.setBackground(color = new Color(154,205,50));
			playerBtn.setForeground(Color.BLACK);
		}
		else if(me.getSource()== matchBtn)
		{
			matchBtn.setBackground(color = new Color(154,205,50));
			matchBtn.setForeground(Color.BLACK);
		}
		else if(me.getSource()== coachBtn)
		{
			coachBtn.setBackground(color = new Color(154,205,50));
	...
	public void mouseExited(MouseEvent me)
	{
		if(me.getSource() == managerBtn)
		{
			managerBtn.setBackground(color = new Color(218,165,32));
			managerBtn.setForeground(Color.BLACK);
		}
		else if(me.getSource()== playerBtn)
		{
			playerBtn.setBackground(color = new Color(218,165,32));
			playerBtn.setForeground(Color.BLACK);
		}
		else if(me.getSource()== matchBtn)
		{
			matchBtn.setBackground(color = new Color(218,165,32));
			matchBtn.setForeground(Color.BLACK);
		}
		else if(me.getSource()== coachBtn)
		{
			coachBtn.setBackground(color = new Color(218,165,32));
			coachBtn.setForeground(Color.BLACK);
		}
		else if(me.getSource()== changePasswordBtn)
		{
